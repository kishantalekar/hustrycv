...
export const getMinimalistBoldEducationHTML = (educationItems: EducationItem[], settings: Settings) => {
    ...
    .map(education => `
      <div style="margin-bottom: 24pt; page-break-inside: avoid; padding: 20pt; border: 2pt solid #000000;">
        <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 8pt;">
          <h3 style="font-size: 12pt; font-weight: 700; color: #000000; text-transform: uppercase; letter-spacing: 2px;">${education.degree}</h3>
          <span style="font-size: 10pt; color: #374151; font-weight: 600;">${education.startDate} - ${education.endDate}</span>
        </div>
  ...
  return `
    <div class="minimalist-bold-section">
      <h2 class="minimalist-bold-section-title">EDUCATION</h2>
      ${educationHTML}
    </div>
  `;
};
